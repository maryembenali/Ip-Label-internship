...
here's the [code files ](Feature Extraction.rar)that explains the process of extracting each of the Json file as well as a " Nomenclature " file that explanation the significance of each file and its content.
</br>
